...
Para ello puedes solicitar la información que tu creas necesaria para gestionar la incidencia a: *tech-test-support@enviame.io*
...
Escribe a *tech-test-support@enviame.io* para solicitar mas antecedentes, resolver o derivar la incidencia.
...
Escribe a *tech-test-support@enviame.io* para derivar la incidencia.
...
Escribe a *tech-test-support@enviame.io* para enviar las consultas diseñadas para cada ítem usando el asunto [P5] SQL, e indicando el número de ítem antes de tu script SQL (Ej: Item 5.1: SELECT ... FROM ... WHERE ...;)
...
El reporte debe ser enviado a: *tech-test-support@enviame.io*, usando el asunto [P6] Reporte
